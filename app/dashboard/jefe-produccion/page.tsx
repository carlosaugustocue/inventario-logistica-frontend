...
import {
  IconoHorno, IconoDespacho, IconoCupcake, IconoAlerta,
  IconoChefHat, IconoIngredientes, IconoTurno, IconoReporte,
} from '@/lib/icons';

const tarjetas = [
  { titulo: 'Órdenes activas',  valor: '—', Icono: IconoHorno,    desc: 'Próximo módulo' },
  { titulo: 'Despachos hoy',    valor: '—', Icono: IconoDespacho, desc: 'Próximo módulo' },
  { titulo: 'En producción',    valor: '—', Icono: IconoCupcake,  desc: 'Próximo módulo' },
  { titulo: 'Insumos bajos',    valor: '—', Icono: IconoAlerta,   desc: 'Próximo módulo' },
];

const modulos = [
  { nombre: 'Órdenes de Producción', desc: 'Gestión y seguimiento de órdenes activas', Icono: IconoHorno       },
  { nombre: 'Despachos',             desc: 'Registro y control de despachos diarios',   Icono: IconoDespacho    },
  { nombre: 'Insumos y Materiales',  desc: 'Control de ingredientes para producción',   Icono: IconoIngredientes},
  { nombre: 'Turnos',                desc: 'Programación y control de turnos',           Icono: IconoTurno       },
];

export default function DashboardJefeProduccion() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl p-6 text-white shadow-lg relative overflow-hidden"
        style={{ background: 'linear-gradient(135deg, #5C1F1F 0%, #7A2E2E 100%)' }}>
        ...
        <div className="relative flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm mt-0.5" style={{ color: '#F4C8C0' }}>
              Bienvenido, <strong>{sesion?.usuario.nombre}</strong>. Operación productiva y despachos.
            </p>
          </div>
        </div>
      </div>
